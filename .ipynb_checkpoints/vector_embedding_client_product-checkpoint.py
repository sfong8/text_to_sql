...
class EmbeddingBedrock:
    ...
    def create_embeddings(self):
        # documents = JSONLoader(file_path='client_product2.jsonl', jq_schema='.', text_content=False, json_lines=True).load()
        documents = JSONLoader(file_path='client_product.jsonl', jq_schema='.', text_content=False, json_lines=False).load()
        EMBEDDINGS_MODEL_ID='amazon.titan-embed-text-v1'
        # embeddings_model_id='amazon.titan-embed-text-v2'
    ...
    def getSimilaritySearch(self,user_query: str,vcindex):
        ...
        docs = vcindex.similarity_search(user_query,k=20)
